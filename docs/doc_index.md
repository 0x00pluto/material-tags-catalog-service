...
| [workflows/llm-media-search-playbook.md](./workflows/llm-media-search-playbook.md) | 本服务 Agent 检索手册：curl search、可选拼 download_url、回复模板；HTTP 拉取时注入本实例 api_base / FILE_BROWSER_BASE；不调 rebuild |
