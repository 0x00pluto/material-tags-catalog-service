...
| 路径 | 摘要 |
|---|---|
| [contracts/material-tags-catalog.md](./contracts/material-tags-catalog.md) | JSONL / 标签契约与媒体白名单；v2 可选透传 width/height/duration_s/aspect_ratio/orientation；无原媒体不入索引；HTTP search 只读现有行 |
